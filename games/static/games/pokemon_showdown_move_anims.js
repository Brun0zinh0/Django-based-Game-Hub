// GENERATED by fetch_showdown_animations.py -- do not edit.
// Source: github.com/smogon/pokemon-showdown-client @ 218cc779512d67961e8aea0ae666d319e8ccf398 (AGPLv3).
(function (root, factory) {
    if (typeof module === 'object' && module.exports) module.exports = factory();
    else root.PokemonShowdownMoveAnims = factory();
}(typeof self !== 'undefined' ? self : this, function () {
    'use strict';
    // Anim bodies build asset URLs off the Showdown client host; the
    // adapter rewrites fx/ URLs to the local mirror at play time.
    const Config = { routes: { client: 'play.pokemonshowdown.com' } };
const BattleOtherAnims= {
	hitmark: {
		anim(scene, [attacker]) {
...
const BattleMoveAnims= {
	...
	magicaltorque: {
		anim(scene, [attacker, defender]) {
			...
			for (let i = 0; i < 7; i++) {
				...
				const ballArgs= [i < 6 ? 'iceball' : 'mistball', {
					x: attacker.x + offset1 * stepX,
					y: attacker.y + offset1 * stepY + tallerBy,
					z: attacker.z + offset1 * stepZ,
					scale: size[i % 2],
					...
					opacity: opct[(i + 1) % 2],
					time: tick,
				}, 'swing', ...(i === 6 ? ['explode'] : ['gone', { filter: 'saturate(300%)' }]) ];
				ball = ball ? scene.animateEffect(ball, ...ballArgs) : scene.showEffect(...ballArgs);
    ...
    return { BattleMoveAnims, BattleOtherAnims, BattleEffects, commit: '218cc779512d67961e8aea0ae666d319e8ccf398' };
}));
